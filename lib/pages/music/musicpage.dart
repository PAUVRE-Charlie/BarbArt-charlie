...
class _MusicPageState extends State<MusicPage> {
  ...
  FlutterWeekViewEvent _generateInternalEvent(AEvent registration, {DateTime dayOverride, bool permanent = false}) {
    return new FlutterWeekViewEvent(
        ...
        onTap: () {
          if(gAPI.selfClient.uuid != registration.clientUUID && _admin == false && _moderator == false) return; // It is not possible to delete a registration that isn't the selfClient's.
          // TODO : POSSIBLE DE DELETE UN PERMANENT ?
